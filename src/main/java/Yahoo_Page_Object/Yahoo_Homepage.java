...
public class Yahoo_Homepage extends Abstract_Class {
    ...
    //logger reports info to
    public Yahoo_Homepage(WebDriver driver) {
        super();
        PageFactory.initElements(driver, this);
        //says this logger is the same as the super.logger - the same logger as in the abstract class
        this.logger = super.logger;
        //identifying that the logger above here is the same logger in abstract class
